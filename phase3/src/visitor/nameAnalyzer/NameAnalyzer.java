...
public class NameAnalyzer extends Visitor<Void> {
    ...
    public Void visit(ForloopStmt forloopStmt) {
        ...
        try {
            var arrVar = (VariableItem)
                    SymbolTable.top.get(VariableItem.STARTKEY +
                            forloopStmt.getArrayName().getName());
            forVariableItem = new VariableItem(
                    forloopStmt.getIterator().getName(), arrVar.getType()
            );
        }
        catch (ItemNotFoundException e){
            forVariableItem = new VariableItem(forloopStmt.getIterator().getName(),
                    new NoType());
        }
